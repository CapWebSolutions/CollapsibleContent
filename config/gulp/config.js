...
module.exports = function ( moduleRoot ) {
	...
	var moduleSettings = {
		...
		domain: 'collapsiblecontent.local',
		...
		i18n: {
			...
			bugReport: 'https://capwebsolutions.com',
			lastTranslator: 'Cap Web Solutions <info@capwebsolutions.com>',
			team: 'Team <<info@capwebsolutions.com>'
		}
	};
